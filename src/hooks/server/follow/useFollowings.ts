import type { GetFollowingsApiResponse } from "../../../types/api/index";
...
const useFollowings = () => {
    return useMutation<GetFollowingsApiResponse,AxiosError,string>({
        mutationFn: (userId:string) => followApi.GetFollowings(userId),
    })
};
