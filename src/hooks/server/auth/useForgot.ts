import { type ForgotAccountApiResponse, type ForgotAccountInterface } from "../../../types/api/index";
...
const useForgot = () => {
    return useMutation<ForgotAccountApiResponse,AxiosError,ForgotAccountInterface>({
        mutationFn: (forgotObj:ForgotAccountInterface) => authApi.ForgotAccount(forgotObj),
    })
};
