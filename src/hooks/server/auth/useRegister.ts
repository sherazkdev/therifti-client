import { type RegisterApiResponse, type RegisterAccountInterface } from "../../../types/api/index";
...
const useRegister = () => {
    return useMutation<RegisterApiResponse,AxiosError,RegisterAccountInterface>({
        mutationFn: (registerObj:RegisterAccountInterface) => authApi.RegisterAccount(registerObj),
    })
};
