...
class ProductServices implements ProductApiImplmentsInterface {
    ...
    */
    public async CreateProduct(product: any):Promise<CreateProductApiResponse> {
        const response = await this.apiService.Post<CreateProductApiResponse>(
    ...
    */
    public async GetFeaturedProducts(
        sortObj:FeaturedProductsSortingInterface
    ):Promise<FeaturedProductApiResponse> {

        const response = await this.apiService.Post<FeaturedProductApiResponse>(
    ...
    */
    public async SearchProducts(
        searchPayload:SearchProductsPayloadInterface
    ):Promise<SearchProductApiResponse> {

        const response = await this.apiService.Post<SearchProductApiResponse>(
            "/products/search",
            searchPayload
        );
